...
# 🔗 Resources
  Here you'll find a collection of useful links and documents related to the Git and GitHub.   
...
- [Git Download](https://git-scm.com/downloads)
  ---  
  You can download the latest version of Git from this link.

- [Git Commands](./gitCommands.md)  
  ---  
  This document explains the git commands discussed in the tutorial videos, along with examples.
...
-  Once **Git Bash** is open, run the following command to clone the repository:
 ...
 ```bash
git clone https://github.com/aKaReZa75/Git.git
```
